...
public class MainWindow extends javax.swing.JFrame {
	...
	private void browseInput() {
		File startupDir = new File(project.input);
	...
	private void browseOutput() {
		File startupDir = new File(project.output);
		if (!startupDir.isDirectory()) startupDir = new File(".");
            ...
            .addGroup(projectPanelLayout.createSequentialGroup()
                ...
                .addGroup(projectPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(projectPanelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(launchPackBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 293, Short.MAX_VALUE))
                    .addGroup(projectPanelLayout.createSequentialGroup()
